...
display(impulse);
subplot(6,1,2);
stem(n,impulse); %discrete time için
ylabel('amplitude');
xlabel('number of samples--->');
title('discrete unit impulse signal');
display(impulse);
%Unit Step grafiði için
t = (-30:1:30)'; 
...
%%
%4. Soru
%Workshopta anlatýlana göre yapýldý.
clc
clear all
close all
t=-10:1:10;
...
%%
%7. Soru
%Workshopta anlatýlmadý.
%Aþaðýdaki linke göre yapýldý.
